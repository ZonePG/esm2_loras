...
def train_protein_model():
    ...
    train_dataframe = pd.read_json("Data/KKM/kkm_data.json")
    train_dataframe["value"] = train_dataframe["value"].apply(np.log10)
    test_dataframe = pd.read_excel("Data/KKM/kkm_test_results.xlsx")
    ...
    output_dir = f"KKM-esm2_t6_8M-finetuned-lora_{timestamp_str}"
