...
def train_protein_model():
    ...
    train_dataframe = pd.read_json("Data/KCAT/kcat_data.json")
    train_dataframe["value"] = train_dataframe["value"].apply(np.log10)
    test_dataframe = pd.read_excel("Data/KCAT/kcat_test_results.xlsx")
    test_dataframe["sequence"] = test_dataframe["seq"]
    test_dataframe["value"] = test_dataframe["experimental value[log10]"]
    ...
    class ProteinDataset(Dataset):
        def __init__(self, dataframe, tokenizer, max_length=512):
            ...
            self.solubilities = dataframe["value"].tolist()
    ...
    output_dir = f"KCAT-esm2_t6_8M-finetuned-lora_{timestamp_str}"
